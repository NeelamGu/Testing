   ...
   <section class="home-banner">
      ...
      <div class="auto-container">
         <div class="banner-text">
            ...
            <p>Trenger du noe til ditt neste arrangement? Beskriv dine ønsker og få leverandører fra hele landet til å kontakte deg.<br> Helt gratis og uforpliktende!</p>
         ...
         <div class="owl-carousel sponsored-slider owl-theme">
            ...
            <div class="item">
               ...
               <div class="event-details detail-t-data ">
                  <div class="">
                     <a href="{{ url('product/'.$getProductURL.'/'.$item['id']) }}">
                        <h4 class="text-thm pb-5 font-weight-700">{{$item['product_name']}}</h4>
                     </a>
                  </div>
                  ...
                  <address class="text-dark font-14  mb-0 detail-adress">
                     ...
                     <span class="pl-5"> <?php /* @if($item['address']!=""){{$item['address']}},@endif */ ?> 
                     <!-- {{$item['city']}} -->

                     {{ ucfirst(strtolower($item['city'])) }}&nbsp;&nbsp;</span>
                     <?php $getCategoryImage = Category::getCategoryImage($item['category_id']); ?>
         ...
         <div class="owl-carousel sponsored-slider owl-theme">
            ...
            <div class="item">
               ...
               <div class="event-details detail-t-data ">
                  ...
                  <address class="text-dark font-14 mb-0 detail-adress">
                     <i class="fa fa-map-marker text-thm"></i><span class="pl-5"> <?php /* @if($item['address']!=""){{$item['address']}},@endif */ ?> {{ ucfirst(strtolower($item['city'])) }}&nbsp;&nbsp;</span>
                     <?php $getCategoryImage = Category::getCategoryImage($item['category_id']); ?>
                     <div class="p-detail-category">
                        @if($getCategoryImage!="")
                           <img class="category-img-icon" src="{{ asset('front/images/category_images/'.$getCategoryImage) }}">
