            ...
            <div class="row clearfix">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 column pull-left">
                    <div class="sec-title account-heading">
                        <h3 style="margin-bottom:15px;" class="font-20 text-black account-title">LEGG UT NY ANNONSE</h3>
                    </div>
                    <div class="form-box p-xs-15 account-form">
                        ...
                        @endif
                        <form action="{{ url('user/add-product/'.$category_id) }}" class="post-form-form" method="post" enctype="multipart/form-data">@csrf
                           <input type="hidden" name="category_id" value="{{ $category_id }}">
                            <div class="row clearfix">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label">Valgt kategori (<a href="{{url('user/select-category')}}">endring</a>)</div>
                                    <?php $getCategoryName = Category::getCategoryName($category_id); ?>
                                    <input type="text" placeholder="" value="{{ $getCategoryName }}" readonly style="background-color:#f2f2f2">
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <textarea style="height:70px;" name="description" required></textarea>
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label">Pris</div>
                                    <input type="number" name="product_price" placeholder="" required>
                                </div>
                                <div class="form-group for col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label">Last opp opptil 8 bilder</div>
                                    <input style="line-height: 35px;" class="form-control" type="file" id="myFile" name="images[]" required multiple>(Anbefalt bildestørrelse:1000x1000)
                                </div>
                                <!-- <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label">Confirm Your Location</div>
                                    <select class="account-state" id="" name="" class="form-control valid" data-height="40px" required="">
