<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2' style="padding: 10px;">Hei {{ $product_name }}</td>
            </tr>
            <tr>
                <td class='style2' style="padding: 10px;">{{ $customer_name }} har sendt deg en ny melding. Vennligst gå inn på Samling.no for å lese meldingen.<br><button><a href="{{ url('admin/products-enquiries') }}">Se melding</a></button></td>
            </tr>
            <tr>
