<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2' style="padding: 10px;">Ditt oppdrag er registrert og sendt ut til alle aktuelle leverandører. Takk for at du bruker Samling og lykke til med ditt arrangement!
Ved eventuelle spørsmål, vennligst ta kontakt.</td><br>
            </tr>
            <tr>
