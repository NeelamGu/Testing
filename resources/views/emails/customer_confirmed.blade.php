<html>
    ...
    <body>
        <table width='80%' border='0' cellpadding='3' cellspacing='3' style='border:#EFEFEF 5px solid; padding:5px;'>
            ...
            <tr>
                <td class='style2' style="padding: 10px;">Du kan legge ut et eller flere oppdrag ved å beskrive dine ønsker, eller utforske leverandører i din valgte kategori og område. Motta tilbud fra flere, sammenlign og velg den som passer deg og ditt budsjett.</td>
            </tr>  
            <tr>
                <td class='style2' style="padding: 10px;"></td>
            </tr>
