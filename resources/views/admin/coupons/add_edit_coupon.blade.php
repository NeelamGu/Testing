                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="categories[]" class="form-control text-dark" multiple="" required="">
                  ...
                  <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="expiry_date" id="expiry_date" placeholder="Enter Expiry Date" @if(isset($coupon['expiry_date'])) value="{{ $coupon['expiry_date'] }}" @else value="{{ old('expiry_date') }}" @endif>
                  </div>
