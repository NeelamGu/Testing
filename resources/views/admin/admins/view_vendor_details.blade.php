                ...
                <div class="card-body">
                  <h4 class="card-title">Personal Information</h4>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="company_name" name="company_name" value="{{ $vendorDetails['vendor_personal']['company_name'] }}" readonly="">
                    </div>
                    <div class="form-group">
                      <label for="organisation_number">Organisation Number</label>
                      <input type="text" class="form-control" id="organisation_number" name="organisation_number" value="{{ $vendorDetails['vendor_personal']['organisation_number'] }}" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="birth_date" placeholder="Enter Date Of Birth" name="birth_date" value="{{ $vendorDetails['vendor_personal']['birth_date'] }}" readonly>
                    </div> -->
                    <!-- <div class="form-group">
                      <label for="gender">Gender</label>
                      <select class="form-control" id="gender" name="gender"  style="color: #495057;" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="instagram" placeholder="Enter Instagram Link" name="instagram" value="{{ $vendorDetails['vendor_personal']['instagram'] }}" readonly>
                    </div>
                    <div class="form-group">
                      <label for="facebook">Facebook</label>
                      <input type="text" class="form-control" id="facebook" placeholder="Enter Facebook Link" name="facebook" value="{{ $vendorDetails['vendor_personal']['facebook'] }}" readonly>
                    </div>
                    <div class="form-group">
                      <label for="tiktok">Tik-tok</label>
                      <input type="text" class="form-control" id="tiktok" placeholder="Enter Tik-tok Link" name="tiktok" value="{{ $vendorDetails['vendor_personal']['tiktok'] }}" readonly>
                    </div>
                    <div class="form-group">
                      <label for="youtube">Youtube</label>
                      <input type="text" class="form-control" id="youtube" placeholder="Enter Youtube Link" name="youtube" value="{{ $vendorDetails['vendor_personal']['youtube'] }}" readonly>
                    </div>
                    <div class="form-group">
                      <label for="website">Website</label>
                      <input type="text" class="form-control" id="website" placeholder="Enter Website Link" name="website" value="{{ $vendorDetails['vendor_personal']['website'] }}" readonly>
                    </div>
