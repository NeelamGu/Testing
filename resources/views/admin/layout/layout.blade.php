...
<head>
  ...
  <title>Samling Admin Panel</title>
  <!-- plugins:css -->
...
<body>
  ...
  @if(isset($product['all_norway']) && $product['all_norway']=="limited")
    <script>$(".allnorway").show();</script>
  @else
    <script>$(".allnorway").hide();</script>
  @endif
    ...
    $("#files").on("change", function(e) {
      ...
      for (var i = 0; i < filesLength; i++) {
        ...
        fileReader.onload = (function(e) {
          ...
          /*$("<span class=\"pip\">" +
            "<img class=\"imageThumb\" src=\"" + e.target.result + "\" title=\"" + file.name + "\"/>" +
            "<br/><span><input style='width:116px;' type='text' placeholder='Title' name='title[]'></span>" +
            "<br/><span class=\"remove\">Remove</span>" +
            "</span>").insertAfter("#files");
          $(".remove").click(function(){
            $(this).parent(".pip").remove();
