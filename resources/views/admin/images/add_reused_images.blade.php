            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ url('admin/add-reused-images/'.$product['id']) }}" method="post" enctype="multipart/form-data">@csrf
                  ...
                  <br><br><h4 class="card-title">Item Images</h4>
